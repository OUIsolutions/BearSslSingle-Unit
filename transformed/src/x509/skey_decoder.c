...
static const unsigned char (BEAR_SINGLE_UNITY_FILE)t0_codeblock[] = {
	...
	0x00, 0x00, 0x01, T0_INT2(offsetof((BEAR_SINGLE_UNITY_FILE)CONTEXT_NAME, key_data)), 0x00,
	0x00, 0x01, T0_INT2(offsetof((BEAR_SINGLE_UNITY_FILE)CONTEXT_NAME, key_type)), 0x00, 0x00,
	0x33, 0x48, 0x00, 0x00, 0x01, T0_INT2(offsetof((BEAR_SINGLE_UNITY_FILE)CONTEXT_NAME, pad)),
...
#define (BEAR_SINGLE_UNITY_FILE)T0_INTERPRETED   34
...
(BEAR_SINGLE_UNITY_FILE)T0_DEFENTRY(br_skey_decoder_init_main, 73)
